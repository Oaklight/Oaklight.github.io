const I18N = {
  en: {
    ...
    tag_llm: 'LLM Systems',
    research_focus: 'My research focuses on making LLM systems more interoperable, tool-using, and reliable in practice. I build abstractions for cross-provider APIs and tool ecosystems, and I study constrained software design and evaluation methods that improve correctness, deployability, and real-world usability.',
  ...
  zh: {
    ...
    tag_llm: 'LLM 系统',
    research_focus: '我的研究聚焦于让 LLM 系统在真实场景中更具互操作性、工具使用能力与可靠性。我构建跨提供商 API 与工具生态的抽象层，并研究受约束的软件设计与评测方法，以提升系统的正确性、可部署性与实际可用性。',
    cat_selected: '精选项目',
    cat_notable: '值得一提的工具',
